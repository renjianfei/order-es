...
import com.hualala.order.es.OrderElasticsearchApplication;
...
/**
 * Tests for {@link OrderElasticsearchApplication}.
 *
...
public class SampleElasticsearchApplicationTests {
	...
	public void testDefaultSettings() throws Exception {
		new SpringApplicationBuilder(OrderElasticsearchApplication.class).run();
